...
export class Content {
  ...
  init() {
    this.contentWrapper = select('#grid').append('div').attr('id', 'content-wrapper');
    ...
    this.credits = this.contentWrapper.append('div').attr('id', 'page-credits');
    ...
    this.credits
      ...
      .attr(
        'href',
        'https://www.gc.cuny.edu/data-analysis-and-visualization/curriculum-and-degree-information/courses',
      )
      .attr('target', 'blank')
      .append('h2')
      .attr('class', 'title')
